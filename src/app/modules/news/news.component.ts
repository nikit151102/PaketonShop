...
this.news = [
  {
    ...
    summary: 'Мы рады объявить о запуске нашего нового продукта для удобства пользователей.',
  ...
  },
  {
    ...
    summary: 'Наше мобильное приложение теперь поддерживает новые функции и улучшенную навигацию.',
  ...
  },
  {
    ...
    summary: 'Не пропустите сезонную распродажу с скидками до 50% на все категории!',
