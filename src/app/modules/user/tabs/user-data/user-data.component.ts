...
export class UserDataComponent implements OnInit {
  ...
  defaultAvatars: string[] = [
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user1&backgroundColor=667eea,764ba2',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user2&backgroundColor=4facfe,00f2fe',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user3&backgroundColor=f093fb,f5576c',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user4&backgroundColor=667eea,764ba2',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user5&backgroundColor=4facfe,00f2fe',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=user6&backgroundColor=f093fb,f5576c',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar7&backgroundColor=667eea,764ba2',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar8&backgroundColor=4facfe,00f2fe',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar9&backgroundColor=f093fb,f5576c',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar10&backgroundColor=667eea,764ba2',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar11&backgroundColor=4facfe,00f2fe',
    'https://api.dicebear.com/7.x/avataaars/svg?seed=avatar12&backgroundColor=f093fb,f5576c',
  ];
